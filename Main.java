...
public class Main {
    public static void main(String[] args) {
        ...
        // Example registration and login attempts
        service.registerClient("NewClient", "newclient@example.com", "newclient", "newpassword", "NewStreet", "123", "NewCity", false);
        Utilizator newClient = service.login("newclient", "newpassword");
        if (newClient != null) {
            System.out.println("Registration and login successful for user: " + newClient.getNume());
        } else {
            System.out.println("Registration or login failed for user: newclient");
        }

        service.registerSofer("NewDriver", "newdriver@example.com", "newdriver", "newpassword", "NewLocation", true);
        Utilizator newDriver = service.login("newdriver", "newpassword");
        if (newDriver != null) {
            System.out.println("Registration and login successful for user: " + newDriver.getNume());
        } else {
            System.out.println("Registration or login failed for user: newdriver");
        }

        service.registerManager("NewManager", "newmanager@example.com", "newmanager", "newpassword");
        Utilizator newManager = service.login("newmanager", "newpassword");
        if (newManager != null) {
            System.out.println("Registration and login successful for user: " + newManager.getNume());
        } else {
            System.out.println("Registration or login failed for user: newmanager");
        }
